...
namespace CGM
{
	...
	[Serializable]
	public class ActionWrapper : ScriptableObject//, ISerializationCallbackReceiver
	{
		//[SerializeField]
		protected CGME.Action CGME_action_root = new CGME.ActionGroup();
						
		[SerializeField]
		public List<SerialNode> serial_nodes = new List<SerialNode>();
				
		public CGME.Action CGME_ActionRoot{
		...
		public void OnBeforeSerialize()
		{
			...
			//Debug.Log (CGME_action_root.CGType);
			// Serialize the root action
			SerialNode root_node = AddNode (CGME_action_root, null);
			
			// Serialize the root's children
			AddChildrenToSerializedNodes(CGME_action_root as CGME.ActionGroup, root_node);
